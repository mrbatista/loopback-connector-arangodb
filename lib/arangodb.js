...
var ArangoDBConnector, Connector, GeoPoint, _, ajs, async, debug, generateConnObject, initialize, merge, qb, url,
...
ArangoDBConnector = (function(superClass) {
  ...
  ArangoDBConnector.prototype._idIncluded = function(fields, idName) {
    var f, i, len;
    if (!fields) {
      return true;
    }
